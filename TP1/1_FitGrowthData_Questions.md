...
![](1_FitGrowthData_Questions_files/figure-markdown_github/unnamed-chunk-3-1.png)
...
![](1_FitGrowthData_Questions_files/figure-markdown_github/unnamed-chunk-5-1.png)

Calibration
===========

To adjust the parameters we first have to quantify the model misfit, ie. we need a function that receives a set of parameter and returns the residuals (ie, the difference between the *g* measured and those predicted by the growth model at the *R* value considered in the measurements).
...
![](1_FitGrowthData_Questions_files/figure-markdown_github/unnamed-chunk-6-1.png)
...
`Fita<-modFit(...)` is now an object of the class `modFit`, which contains a number of attributes, and which can be used as an argument to dedicated functions as illustrated below
